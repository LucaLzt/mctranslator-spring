...
description: >
  Use ONLY when designing or modifying domain models, aggregates, value objects, domain events, or repository interfaces in DDD projects. Enforces rich domain models and invariant protection over anemic CRUD.
---
