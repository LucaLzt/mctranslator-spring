...
description: Use ONLY when writing unit, slice, or integration tests with JUnit 6, AssertJ, MockMvcTester, RestTestClient, or Testcontainers for Spring Boot 4.
---
...
- [references/mockmvc-tester.md](references/mockmvc-tester.md) - AssertJ-style MockMvc (3.4+)
- [references/mockmvc-classic.md](references/mockmvc-classic.md) - Traditional MockMvc (pre-3.4)
