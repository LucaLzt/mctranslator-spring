...
Modern REST client testing with Spring Boot 4+ (alternative to TestRestTemplate).

## Overview

RestTestClient is the modern alternative to TestRestTemplate in Spring Boot 4.0+. It provides a fluent, blocking API for testing REST endpoints.
...
| ------- | -------------- | ---------------- |
| Style | Fluent/blocking | Imperative |
| Spring Boot | 4.0+ | All versions (relocated to `org.springframework.boot.resttestclient` in 4) |
