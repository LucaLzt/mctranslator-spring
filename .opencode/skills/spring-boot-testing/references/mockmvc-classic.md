...
Traditional MockMvc API for Spring MVC controller tests (pre-Spring Boot 3.4 or legacy codebases).

## When to Use This Reference

- The project uses Spring Boot < 3.4 (no `MockMvcTester` available)
...
For new tests on Spring Boot 3.4+, prefer [mockmvc-tester.md](mockmvc-tester.md) instead.
...
5. **Migrate to MockMvcTester** when upgrading to Spring Boot 3.4+ for better readability
