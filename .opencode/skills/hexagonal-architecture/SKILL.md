...
description: >
  Use ONLY when structuring packages into domain/, application/, and infrastructure/ layers, defining ports/adapters, or enforcing zero framework dependencies in core domain code.
---
